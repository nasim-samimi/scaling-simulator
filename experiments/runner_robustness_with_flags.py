...
# flags=['intra_node_removed'] #did we have more flags?
flags=['upgrade_service','node_reclaim','intra_node_realloc','intra_domain_realloc','intra_node_reduced','intra_node_removed'] #did we have more flags?
node_sizes = [8,12,16]
