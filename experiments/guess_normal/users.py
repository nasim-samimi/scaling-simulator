...
def UserTiming(Services,num_users,dir,num_domains=NUM_DOMAINS):
    ...
    MAX_UP_TIME=20000#int(TOTAL_DURATION/2)
    MIN_UP_TIME=10000
    UP_TIME_RANGE = range(MIN_UP_TIME, MAX_UP_TIME + 1, num_domains)
    NUM_SERVICE_PER_USER = range(10, 20)
    ...
    for userID in otherUserIDs:
        ...
        max_arrival_time = random.choice(range(int(min_arrival_time*2*100),int(min_arrival_time*4*100)))/100
        ...
        while arrival<eventsLength:
            ...
            for d in u['Domains']:
                ...
                for s in u['Services']:
                    ...
                    eventTime.append(round(temp_et,2))
