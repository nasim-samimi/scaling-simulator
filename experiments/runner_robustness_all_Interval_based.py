...
if __name__=='__main__':
    ...
    for n in node_sizes:
        ...
        robustness(dir1=dir,metric='cost',flags='all_interval_based',nodesize=n)            
        robustness(dir1=dir,metric='qos',flags='all_interval_based',nodesize=n)
        robustness(dir1=dir,metric='qosPerCost',flags='all_interval_based',nodesize=n)
