                ...
                for addition in ADDITION:
                    for p in PARTITIONING_H:
                        for n in NODE_SELECTION_H:
                            ...
                            config["system"]["results_dir"] = f'{results_dir}/c{cost}/allOpts/max_scaling_threshold={th}'
                            ...
                            config["orchestrator"]["cloud_node_cost"]=cost
