...
# === PARAMETERS ===
INPUT_FILE = "data/events_real/domain_events_cleaned.csv"
OUTPUT_FILE = "data/events_real/final_events_with_services.csv"
    ...
    if row['event_type'] == 'allocate':
        ...
        if (
            ...
            for sid in services:
                ...
                final_rows.append({
                    'EventTime': next_row['time'],
                    'EventType': 'deallocate',
                    'ServiceID': sid,
                    'DomainID': next_row['domain'],
                    'EventID': event_counter,
                    'TotalUtil': 0,
                    'ID': uid
                })
