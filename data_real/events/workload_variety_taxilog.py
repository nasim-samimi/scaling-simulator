...
# === PARAMETERS ===
INPUT_FILE = "data_real/events/taxi_log_final_events_with_services.csv"
OUTPUT_DIR = "data_real/events/taxilog"
...
for level in SPARSITY_LEVELS:
    ...
    output_file = os.path.join(OUTPUT_DIR, f"events_{(level)}.csv")
